defmodule FirstWeb.ExpenseLiveTest do
  ...
  @create_attrs %{date: "2026-01-04", description: "some description", category: "some category", amount: "120.5"}
  @update_attrs %{date: "2026-01-05", description: "some updated description", category: "some updated category", amount: "456.7"}
