    ...
    <Layouts.app flash={@flash} current_scope={@current_scope}>
      <div class="mx-auto max-w-sm">
        ...
        >
          ...
          <.button
            phx-disable-with="Confirming..."
            class="font-medium bg-white text-black border border-gray-300 m-4 rounded-md px-4 py-2 hover:bg-gray-100 transition flex-1 w-full text-center"
          >
        ...
        <p
          :if={!@user.confirmed_at}
          class="font-normal bg-white text-gray-900 text-sm border border-gray-300 m-4 rounded-md px-4 py-2 hover:bg-gray-100 transition flex-1 w-full text-center"
        >
